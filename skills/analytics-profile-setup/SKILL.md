...
- `get_overview` confirms actual monthly traffic (vs self-reported Q4).
- `get_top_referrers` confirms the analytics tool is picking up the major channels the user mentioned.
- `get_events` confirms the primary conversion event is actually being fired and named consistently.
