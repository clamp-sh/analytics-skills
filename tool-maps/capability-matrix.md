...
Last reviewed: 2026-04-29 (PostHog, Mixpanel, Amplitude verified first-hand against current docs and registered tool definitions; GA4 verified against the official Python wrapper source). Vendors ship MCP changes regularly; values may shift. Per-row invocations live in each tool-map.
